...
const Login = () => {
  ...
  return (
    <form action="" className='min-h-[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-center p-8 sm:min-w-[340px] border rounded-xl text-zinc-600 text-sm shadow-lg'>
      <p className='text-2xl font-semibold '>{state === 'Sign up'?'CREATE ACCOUNT':'LOGIN'}</p>
       ...
       {state === 'Sign up'? <div className='w-full'>
        ...
        <button className='bg-primary text-white py-2 rounded-md w-full text-base'>{state === 'Sign up'?'Create Account':'Login'}</button>
